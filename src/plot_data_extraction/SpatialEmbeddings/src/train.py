...
#     print("train data batch: ",len(train_dataset_it))
# #     train_dataset_it.dataset.transform.transforms[0].ratio = np.random.choice([1/3,1/2,2/3,1.,3/2,2.,3.])
#     print(train_dataset_it.dataset.transform.transforms[0].ratio)
